                                ...
                                <div class="basic-form">
                                    <form method="post" action="index.php">
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" name="to-mobile" class="form-control" placeholder="233540000, 23356000">
                                            </div>
                                        </div>
                                        <div class="mb-3 row">
                                        ...
                                        <div class="mb-3 row">
                                            <div class="col-sm-10">
                                                <button type="submit" name="submit" value="quick-sms" class="btn btn-primary">Send Quick</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
